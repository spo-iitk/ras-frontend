...
function Step1() {
  return (
    <div style={{ padding: "0 2rem" }}>
      <Meta title="Step 1/5 - New Opening" />
      <Stack spacing={2}>
          ...
          <TableContainer component={Paper} sx={{ minWidth: 330, maxWidth: 700 }}>
            <Table sx={{ minWidth: 300, maxWidth: 700, backgroundColor: '#ebebeb' }} aria-label="simple table">
              <TableBody> 
                ...
                <TableRow>
                  <TableCell align='left' component="th" scope="row" sx={{ fontSize: "1.01em", fontWeight: '600', paddingLeft: '7vw' }}>Nature of Business</TableCell>
                  <TableCell>
                  <TextField
                      variant="outlined"
                      value={"SDE Intern"}
