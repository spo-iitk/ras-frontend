    ...
    <div className={styles.container}>
      ...
      <div style={{marginTop:50}}>
        <Card elevation={5} sx={{padding:3,  width:{xs:'330px', sm:'500px', margin: '0px auto'}}}>
          <Stack spacing={3}>
            <h1 >Add Company</h1>
            <Typography>Note: If company is not listed here then it might be not listed in the master database. Add it there first.</Typography>
            <TextField label="Select Company" id="selectCompany" variant="filled" />
            <TextField label="Select Active HR" id="selectActiveHR" variant="filled" />
