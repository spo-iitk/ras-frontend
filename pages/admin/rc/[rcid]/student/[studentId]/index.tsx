...
import { IconButton, Stack, Card, TextField, Typography, Grid, Box } from "@mui/material";
  ...
  return (
    <div>
      <Card
        ...
        sx={{
          padding: 5,
          width: { lg: "1200px", md: "900px", xs: "330px", sm: "500px", margin: "0px auto" },
      ...
      <Card
        ...
        sx={{
          padding: 2,
          width: { lg: "1200px", md: "900px", xs: "330px", sm: "500px", margin: "40px auto" },
        }}
      >
        ...
        {
          questions.map((que) => (
            <Box display="grid" gridTemplateColumns="repeat(12, 1fr)" gap={2} rowGap={2}>
              <Box gridColumn="span 6">
              ...
              <Box gridColumn="span 12">
                <TextField id={que.id} value={que.answer} variant="outlined" fullWidth style={{ margin: "20px auto 20px" }} />
              </Box>
            </Box>
          ))
        }
      ...
      > 
        <Stack>
          ...
          <Stack direction='row' style={{justifyContent:'space-between',marginBottom:'40px'}}>
            ...
            </Box>
        {
          applicationStatus.map((as) => (
            <Box display="grid" gridTemplateColumns="repeat(12, 1fr)" gap={2}>
              ...
              <Box gridColumn="span 2">
                <ActiveButton><Link href={as.resume}>Link</Link></ActiveButton>
              </Box>
              <Box gridColumn="span 3">
