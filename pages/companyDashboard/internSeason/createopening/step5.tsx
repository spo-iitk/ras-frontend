        ...
        <Stack spacing={2} justifyContent="center" alignItems="center" sx={{paddingBottom: 10}}>
          ...
          <TableContainer component={Paper} sx={{ minWidth: 330, maxWidth: 700 }}>
            <Table sx={{ minWidth: 300, maxWidth: 700, backgroundColor: '#ebebeb' }} aria-label="simple table">
              <TableBody> 
                <TableRow>
                  <TableCell align='left' component="th" scope="row" sx={{ fontSize: "1.01em", fontWeight: '600', paddingLeft: '7vw' }}>Additional Eligibility Criteria</TableCell>
                  <TableCell>
                    <TextField
                      variant="outlined"
                      value={"Quadeye"}
                ...
                <TableRow>
                  <TableCell align='left' component="th" scope="row" sx={{ fontSize: "1.01em", fontWeight: '600', paddingLeft: '7vw' }}>Message for Placement Coordinator</TableCell>
                  <TableCell>
                  <TextField
                      variant="outlined"
                      value={"SDE Intern"}
                ...
                <TableRow>
                  <TableCell align='left' component="th" scope="row" sx={{ fontSize: "1.01em", fontWeight: '600', paddingLeft: '7vw' }}>Select Active HR</TableCell>
                  <TableCell>
                  <TextField
                      variant="outlined"
                      value={"USA"}
