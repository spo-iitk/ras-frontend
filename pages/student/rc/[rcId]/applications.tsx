...
const rows = [
  { id:1,companyName: "Google", role: 'Software Dev', deadline: '12:00AM 31 May 2022', resume: "ID:2 Page Software Dev " },
  { id:2,companyName: "Microsoft", role: 'Software Dev', deadline: '12:00AM 31 May 2022', resume: "ID:1 Page Software Dev" }
];
...
function Applications() {
  return (
      <div className={styles.container}>
        ...
        <Stack>
          <div style={{ height: 500, margin: '10px auto' }} className={styles.datagridApplications}>
            <DataGrid
              rows={rows}
              columns={columns}
              pageSize={7}
